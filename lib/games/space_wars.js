        ...
        equip : [
          {
            ...
            display : [
              ...
              },
              {
                ...
                display : [
                  {
                    classes : "flexrow flexaround fit-x subtitle",
                    display : [
                      ...
                      applyUI : {
                        classes : "flexrow subtitle outlinebottom flex smooth spadding white", style : {"border-radius" : "6px"}, display : [
                          ...
                          {classes : "flexrow flexmiddle", display : [
                            {classes : "subtitle bold", ui : "ui_checkbox", scope : {saveInto : "@skillTarget.current", checked : 1, unchecked : 0, cond : "@c.@skillTarget.current==1", title : "Career", style : {"width" : "10px", "height" : "10px"}}},
                            {classes : "lrmargin subtitle flexmiddle", name : "Career"},
                          ]},
                          {classes : "flexrow flexmiddle", display : [
                            {classes : "lrmargin subtitle flexmiddle", name : "Rank"},
                            {ui : "ui_checkbox", scope : {saveInto : "@skillTarget.modifiers.rank", checked : "1", unchecked : "0", cond : "@c.@skillTarget.modifiers.rank>=1", title : "Rank 1", style : {"width" : "10px", "height" : "10px"}}},
                            {ui : "ui_checkbox", scope : {saveInto : "@skillTarget.modifiers.rank", checked : "2", unchecked : "1", cond : "@c.@skillTarget.modifiers.rank>=2", title : "Rank 2", style : {"width" : "10px", "height" : "10px"}}},
                            {ui : "ui_checkbox", scope : {saveInto : "@skillTarget.modifiers.rank", checked : "3", unchecked : "2", cond : "@c.@skillTarget.modifiers.rank>=3", title : "Rank 3", style : {"width" : "10px", "height" : "10px"}}},
                            {ui : "ui_checkbox", scope : {saveInto : "@skillTarget.modifiers.rank", checked : "4", unchecked : "3", cond : "@c.@skillTarget.modifiers.rank>=4", title : "Rank 4", style : {"width" : "10px", "height" : "10px"}}},
                            {ui : "ui_checkbox", scope : {saveInto : "@skillTarget.modifiers.rank", checked : "5", unchecked : "4", cond : "@c.@skillTarget.modifiers.rank>=5", title : "Rank 5", style : {"width" : "10px", "height" : "10px"}}},
                          ]},
                          {
                            cond : "('@statKey')!=''",
