...
exports.templates = {
  ...
  constants : {
    basearmor : `{"human_head" : "#:T+@c.counters.nnT+@c.counters.daemonic","human_torso" : "#:T+@c.counters.nnT+@c.counters.daemonic","human_larm" : "#:T+@c.counters.nnT+@c.counters.daemonic","human_rarm" : "#:T+@c.counters.nnT+@c.counters.daemonic","human_lleg" : "#:T+@c.counters.nnT+@c.counters.daemonic","human_rleg" : "#:T+@c.counters.nnT+@c.counters.daemonic"}`,
    ws : "(@c.stats.WS/10)f",
    bs : "(@c.stats.BS/10)f",
    s : "(@c.stats.S/10)f",
    t : "(@c.stats.T/10)f",
  ...
  tables : {
    RAW : {
      "T" : "((@c.stats.T/10)f+@c.counters.nnT+@c.counters.daemonic)", // Basic toughness
      "TB" : "((@c.stats.T/10)f+@c.counters.nnT", // toughness bonus (No daemonic)
      "TR" : "((@c.stats.T/10)f", // Raw Toughness
    }
  },
  effects : {
  ...
  display : {
    ...
    sheet : {
                ...
                display : [
                  {
                    classes : "flexrow", display : [
                      {classes : "flexrow flexmiddle lrmargin bold", display : [
                        {classes : "bold", target : "counters.wounds", edit : {classes : "line", style : {width : "24px", "text-align" : "center"}}},
                      ...
                      {classes : "flexcolumn flex flexmiddle spadding", target : "counters.wounds", ui : "ui_progressBar", scope : {bar : true, value : "counters.wounds", max : "counters.wounds.max"}}
                    ]
                  },
                  {
                    classes : "flexrow", display : [
                      {classes : "flexrow flexmiddle lrmargin bold", display : [
                        {classes : "bold", target : "counters.exhaustion", edit : {classes : "line", style : {width : "24px", "text-align" : "center"}}},
                        {classes : "lrmargin bold", value : "/"},
                        {classes : "bold", name : "", target : "counters.exhaustion", edit : {classes : "line", style : {width : "24px", "text-align" : "center"}, raw : "max"}},
                      ]},
                      {classes : "flexcolumn flex flexmiddle spadding", target : "counters.exhaustion", ui : "ui_progressBar", scope : {bar : true, value : "counters.exhaustion", max : "counters.exhaustion.max"}}
                    ]
                  },
                  {
                    classes : "flexrow flexbetween subtitle spadding", display : [
                      {classes : "flexrow flexmiddle lrmargin bold", display : [
                        {classes : "bold", target : "counters.insanity", edit : {classes : "line", style : {width : "24px", "text-align" : "center"}}},
                        {classes : "lrmargin bold", value : "/"},
                        {classes : "bold", name : "", target : "counters.insanity", edit : {classes : "line", style : {width : "24px", "text-align" : "center"}, raw : "max"}},
                      ]},
                      {classes : "flexrow flexmiddle lrmargin bold", display : [
                        {classes : "bold", target : "counters.corruption", edit : {classes : "line", style : {width : "24px", "text-align" : "center"}}},
                        {classes : "lrmargin bold", value : "/"},
                  ...
                  {
                    classes : "flexrow subtitle spadding", display : [
                      {classes : "flexrow flexmiddle lrmargin bold", display : [
                        {classes : "bold", target : "counters.fate", edit : {classes : "line", style : {width : "24px", "text-align" : "center"}}},
                        {classes : "lrmargin bold", value : "/"},
                        {classes : "bold", name : "", target : "counters.fate", edit : {classes : "line", style : {width : "24px", "text-align" : "center"}, raw : "max"}},
                      ]},
                      {classes : "flexcolumn flex flexmiddle spadding", target : "counters.fate", ui : "ui_progressBar", scope : {bar : true, value : "counters.wounds", max : "counters.wounds.max"}}
                    ]
                  },
                  {
                    classes : "flexrow spadding",
                    display : [
                      {classes : "lrpadding", title : "Map Token", target : "info.img", ui : "ui_token", scope : {classes : "smooth outline white"}},
                    ]
                  },
                  /*
                  {classes : "flexrow", display : [

                    {target : "counters.exp", ui : "ui_expCounter"}
                  ]},*/
                ]
              }
            ]
          },
          {classes : "flexrow flexwrap", display : [
            {classes : "flexrow flexwrap", target : "stats", applyUI : {
              display : {classes : "flexrow flexmiddle", style : {"width" : "20%"}, display : [
                {classes : "flexcolumn flexmiddle smooth", display : [
                  {classes : "flexrow flexmiddle spadding", display : [
                    {name : "@applyKey(e)", classes : "lrpadding bold destroy", style : {"font-size" : "1.2em"}, cond : "(@c.counters.exhaustion>(@c.@applyTarget/10)f)?(1):(0)",},
                    {name : "@applyKey", classes : "lrpadding bold", style : {"font-size" : "1.2em"}, cond : "(@c.counters.exhaustion>(@c.@applyTarget/10)f)?(0):(1)",},
                    {name : "", target : "@applyTarget", edit : {classes : "lrmargin line middle", style : {"width" : "24px"}, raw : "1"}},
                    {classes : "flexmiddle", ui : "ui_link", scope : {classes : "flexmiddle", icon : "'list-alt'", click : "ui_modifiers", lookup : "@applyTarget", attr : {"modsOnly" : true}}},
                  ]},
                  {classes : "bold hover2 spadding white outline smooth flexmiddle fit-x", style : {"min-width" : "30px", "font-size" : "1.4em"},
                    value : "@c.@applyTarget",
                    cond : "'@applyKey'!='Ifl'",
                    click : {action : "Stat Test", msg : "tested @c.@applyTarget.name", options : {"stat" : "@c.@applyTarget", "degBonus" : "(@nn@applyKey/2)f"}}
                  },
                  {classes : "bold hover2 spadding white outline smooth flexmiddle fit-x", style : {"min-width" : "30px", "font-size" : "1.4em"},
                    value : "@c.@applyTarget",
                    cond : "'@applyKey'=='Ifl'",
                    click : {action : "Stat Test", msg : "tested @c.@applyTarget.name", options : {"bonus" : "@c.@applyTarget"}}
                  },
                  {
                    cond : "'@applyKey'!='Ifl'",
                    classes : "flexrow flexaround",
                    display : [
                      {title : "Rank 1", target : "@applyTarget", ui : "ui_checkbox", scope : {saveInto : "@applyTarget.modifiers.rank", cond : "@c.@applyTarget.modifiers.rank>=5", checked : "5", unchecked : "0"}},
                      {title : "Rank 2", target : "@applyTarget", ui : "ui_checkbox", scope : {saveInto : "@applyTarget.modifiers.rank", cond : "@c.@applyTarget.modifiers.rank>=10", checked : "10", unchecked : "5"}},
                      {title : "Rank 3", target : "@applyTarget", ui : "ui_checkbox", scope : {saveInto : "@applyTarget.modifiers.rank", cond : "@c.@applyTarget.modifiers.rank>=15", checked : "15", unchecked : "10"}},
                      {title : "Rank 4", target : "@applyTarget", ui : "ui_checkbox", scope : {saveInto : "@applyTarget.modifiers.rank", cond : "@c.@applyTarget.modifiers.rank>=20", checked : "20", unchecked : "15"}},
                      {title : "Rank 5", target : "@applyTarget", ui : "ui_checkbox", scope : {saveInto : "@applyTarget.modifiers.rank", cond : "@c.@applyTarget.modifiers.rank>=25", checked : "25", unchecked : "20"}},
                    ]
                  },
                ]}
              ]},
      ...
      /*content : {
        ...
        display : [
          {classes : "flexrow flexwrap", target : "stats", applyUI : {
            display : {classes : "flexrow flexmiddle", display : [
              {classes : "flexcolumn flexmiddle smooth", display : [
                {
                  cond : "'@applyKey'!='Ifl'",
                  classes : "flexrow flexaround",
                ...
                {classes : "bold hover2 spadding white outline smooth flexmiddle fit-x", style : {"width" : "20px", "font-size" : "1.2em"},
                  value : "@c.@applyTarget",
                  cond : "'@applyKey'!='Ifl'",
                  click : {action : "Stat Test", msg : "tested @c.@applyTarget.name", options : {"stat" : "@c.@applyTarget", "degBonus" : "(@nn@applyKey/2)f"}}
                },
                {classes : "bold hover2 spadding white outline smooth flexmiddle fit-x", style : {"min-width" : "30px", "font-size" : "1.2em"},
                  value : "@c.@applyTarget",
                  cond : "'@applyKey'=='Ifl'",
                  click : {action : "Stat Test", msg : "tested @c.@applyTarget.name", options : {"bonus" : "@c.@applyTarget"}}
                },
                {classes : "flexrow flexmiddle spadding", display : [
                  {name : "@applyKey", classes : "lrpadding bold destroy", cond : "(@c.counters.exhaustion>(@c.@applyTarget/10)f)?(1):(0)",},
                  {name : "@applyKey", classes : "lrpadding bold", cond : "(@c.counters.exhaustion>(@c.@applyTarget/10)f)?(0):(1)",},
                  {name : "", target : "@applyTarget", edit : {classes : "lrmargin line middle", style : {"width" : "24px"}, raw : "1"}},
                  {classes : "flexmiddle", ui : "ui_link", scope : {classes : "flexmiddle", icon : "'list-alt'", click : "ui_modifiers", lookup : "@applyTarget", attr : {"modsOnly" : true}}},
                ]},
              ]}
            ...
            display : [
              ...
              {classes : "flexcolumn flex padding white outline smooth", display : [
                ...
                {classes : "flexrow flexbetween subtitle", display : [
                  {value : "'Experience ('+(M@c.counters.exp-R@c.counters.exp)+')'", classes : "bold flexmiddle", style : {"width" : "120px"}},
                  {classes : "flexrow flexmiddle subtitle spadding smooth", name : "Available", target : "counters.exp", edit : {classes : "line lrmargin", mod : "Starting", style : {width : "50px", "text-align" : "center"}}},
                  {classes : "flexrow flexmiddle subtitle spadding smooth", name : "Spent", target : "counters.exp", edit : {classes : "line lrmargin", raw : "1", style : {width : "50px", "text-align" : "center"}}},
                ]},
                {
                  classes : "flexcolumn flex padding",
                  display : [
                    {
                      classes : "flexrow flexmiddle spadding",
                      display : [
                        {classes : "lrpadding lrmargin", title : "Map Token", target : "info.img", ui : "ui_token", scope : {classes : "smooth outline white"}},
                      ]
                    },
                  ]
                },
          ...
          {classes : "flexrow flexbetween", display : [
            {classes : "flexcolumn flexmiddle bold outline inactive", display : [
              {classes : "bold smooth lrpadding flexmiddle subtitle", name : "@c.counters.wounds.name"},
              {classes : "flexrow flexmiddle lrmargin bold", style : {"font-size" : "1.6em", "border-radius" : "6px/50%"}, display : [
                {classes : "flexcolumn flexmiddle bold", name : "current", style : {"font-size" : "0.38em"}, target : "counters.wounds", edit : {classes : "smargin subtitle middle outline", style : {"font-size": "1.8em", width : "40px", "border-radius" : "6px/50%"}}},
                {classes : "flexcolumn flexmiddle bold", name : "max", style : {"font-size" : "0.38em"}, target : "counters.wounds", edit : {classes : "smargin subtitle middle outline", style : {"font-size": "1.8em", width : "40px", "border-radius" : "6px/50%"}, raw : "max"}},
              ]},
            ...
            {classes : "flexcolumn flexmiddle lrmargin bold outline inactive", display : [
              {classes : "bold smooth lrpadding flexmiddle subtitle", name : "@c.counters.exhaustion.name"},
              {classes : "flexrow flexmiddle lrmargin bold", style : {"font-size" : "1.6em", "border-radius" : "6px/50%"}, display : [
                {classes : "flexcolumn flexmiddle bold", name : "current", style : {"font-size" : "0.38em"}, target : "counters.exhaustion", edit : {classes : "smargin subtitle middle outline", style : {"font-size": "1.8em", width : "40px", "border-radius" : "6px/50%"}}},
                {classes : "flexcolumn flexmiddle bold", name : "max", style : {"font-size" : "0.38em"}, target : "counters.exhaustion", edit : {classes : "smargin subtitle middle outline", style : {"font-size": "1.8em", width : "40px", "border-radius" : "6px/50%"}, raw : "max"}},
              ]},
              {classes : "flexcolumn fit-x lrmargin lrpadding", display : [{classes : "lrmargin flex", target : "counters.exhaustion", ui : "ui_progressBar", scope : {value : "counters.exhaustion", max : "counters.exhaustion.max"}}]},
            ]},
            {classes : "flexcolumn flexmiddle lrmargin bold outline inactive", display : [
              {classes : "bold smooth lrpadding flexmiddle subtitle", name : "@c.counters.insanity.name"},
              {classes : "flexrow flexmiddle lrmargin bold", style : {"font-size" : "1.6em", "border-radius" : "6px/50%"}, display : [
                {classes : "flexcolumn flexmiddle bold", name : "current", style : {"font-size" : "0.38em"}, target : "counters.insanity", edit : {classes : "smargin subtitle middle outline", style : {"font-size": "1.8em", width : "40px", "border-radius" : "6px/50%"}}},
                {classes : "flexcolumn flexmiddle bold", name : "max", style : {"font-size" : "0.38em"}, target : "counters.insanity", edit : {classes : "smargin subtitle middle outline", style : {"font-size": "1.8em", width : "40px", "border-radius" : "6px/50%"}, raw : "max"}},
              ]},
            ]},
            {classes : "flexcolumn flexmiddle lrmargin bold outline inactive", display : [
              {classes : "bold smooth lrpadding flexmiddle subtitle", name : "@c.counters.corruption.name"},
              {classes : "flexrow flexmiddle lrmargin bold", style : {"font-size" : "1.6em", "border-radius" : "6px/50%"}, display : [
                {classes : "flexcolumn flexmiddle bold", name : "current", style : {"font-size" : "0.38em"}, target : "counters.corruption", edit : {classes : "smargin subtitle middle outline", style : {"font-size": "1.8em", width : "40px", "border-radius" : "6px/50%"}}},
                {classes : "flexcolumn flexmiddle bold", name : "max", style : {"font-size" : "0.38em"}, target : "counters.corruption", edit : {classes : "smargin subtitle middle outline", style : {"font-size": "1.8em", width : "40px", "border-radius" : "6px/50%"}, raw : "max"}},
              ]},
            ]},
            {classes : "flexcolumn flexmiddle bold outline inactive", display : [
              {classes : "bold smooth lrpadding flexmiddle subtitle", name : "@c.counters.fate.name"},
              {classes : "flexrow flexmiddle lrmargin bold", style : {"font-size" : "1.6em", "border-radius" : "6px/50%"}, display : [
                {classes : "flexcolumn flexmiddle bold", name : "current", style : {"font-size" : "0.38em"}, target : "counters.fate", edit : {classes : "smargin subtitle middle outline", style : {"font-size": "1.8em", width : "40px", "border-radius" : "6px/50%"}}},
                {classes : "flexcolumn flexmiddle bold", name : "max", style : {"font-size" : "0.38em"}, target : "counters.fate", edit : {classes : "smargin subtitle middle outline", style : {"font-size": "1.8em", width : "40px", "border-radius" : "6px/50%"}, raw : "max"}},
              ]},
            ]},
          ]},
          {classes : "padding"},
            ...
            display : [
              {
                ...
                display : [
                  {classes : "flexrow flexmiddle", style : {"font-size" : "1.4em"}, display : [
                  ...
                  ]},
                  {
                    ...
                    scope : {
                      lookup : "skills",
                      applyUI : {
                        classes : "flexrow subtitle outlinebottom flex smooth spadding white", display : [
                          ...
                          {
                            cond : "('@statKey')!=''",
                            classes : "hover2 flexmiddle button outline smooth bold subtitle lrpading",
              ...
              },
              {
                ...
                display : [
                  ...
                  {ui : "ui_tagList", scope : {filter : "trait", title : "Traits.."}},
                  ...
                  display : [
                    {
                      ...
                      display : [
                        {cond : "(@c.counters.exhaustion>(@c.@applyTarget/10)f)?(0):(1)", classes : "flexmiddle inactive", name : "", target : "@applyTarget", edit : {classes : "flexmiddle line middle", style : {width : "24px", "border" : "none"}, raw : true}},
                        {cond : "(@c.counters.exhaustion>(@c.@applyTarget/10)f)?(1):(0)", title : "Exhausted",  classes : "flexmiddle inactive destroy", name : "", target : "@applyTarget", edit : {classes : "flexmiddle line middle", style : {width : "24px", "border" : "none"}, raw : true}},
                        {value : "("},
                        {cond : "@c.counters.nn@applyKey.name!=null", name : "", target : "counters.nn@applyKey", edit : {classes : "flexmiddle line bold subtitle", style : {width : "16px", "text-align" : "center"}, raw : true}},
                        {value : ")"},
                      ]
                    },
                  ]
                },
                {classes : "fit-x flexmiddle white bold hover2 spadding outlinebottom", value : "@c.@applyTarget", click : {action : "Stat Test", msg : "tested @c.@applyTarget.name", options : {"threshold" : "@c.@applyTarget"}}},
                {
                  classes : "flexrow flexmiddle",
                  display : [
                    {title : "Rank 1", target : "@applyTarget", ui : "ui_checkbox", scope : {saveInto : "@applyTarget.modifiers.rank", cond : "@c.@applyTarget.modifiers.rank>=5", checked : "5", unchecked : "0", style : {"width" : "10px", "height" : "10px"}}},
                    {title : "Rank 2", target : "@applyTarget", ui : "ui_checkbox", scope : {saveInto : "@applyTarget.modifiers.rank", cond : "@c.@applyTarget.modifiers.rank>=10", checked : "10", unchecked : "5", style : {"width" : "10px", "height" : "10px"}}},
                    {title : "Rank 3", target : "@applyTarget", ui : "ui_checkbox", scope : {saveInto : "@applyTarget.modifiers.rank", cond : "@c.@applyTarget.modifiers.rank>=15", checked : "15", unchecked : "10", style : {"width" : "10px", "height" : "10px"}}},
                    {title : "Rank 4", target : "@applyTarget", ui : "ui_checkbox", scope : {saveInto : "@applyTarget.modifiers.rank", cond : "@c.@applyTarget.modifiers.rank>=20", checked : "20", unchecked : "15", style : {"width" : "10px", "height" : "10px"}}},
                    {title : "Rank 5", target : "@applyTarget", ui : "ui_checkbox", scope : {saveInto : "@applyTarget.modifiers.rank", cond : "@c.@applyTarget.modifiers.rank>=25", checked : "25", unchecked : "20", style : {"width" : "10px", "height" : "10px"}}},
                  ]
                },
                {
                  classes : "bold fit-x",
