        ...
        display : [
          {
            ...
            display : [
                  ...
                  {classes : "flexcolumn flexmiddle spadding", target : "counters.hp", ui : "ui_progressBar", scope : {bar : true, value : "counters.hp", max : "counters.hp.max"}},
                  {
                    ...
                    display : [
                      ...
                      ]},
                      {
                        ...
                        style : {"text-align" : "left", 'height' : "210px", "overflow-y" : "auto"},
                        scrl : "inv",
                        ui : "ui_entryList",
                        scope : {
                          drop : "inventoryDrop",
                      ...
                      {classes : "flexrow", cond : "@c.inventory.length>0", display : [
                      ...
                      {classes : "flexcolumn", display : [
                        ...
                        ]},
                        {
                          ...
                          display : [
                            ...
                            {classes : "flexcolumn subtitle white smooth outline spadding", style : {'height' : "190px"}, display : [
              ...
              {
                classes : "flexcolumn flex flexbetween",
                display : [
                  {
                    classes : "flexcolumn",
                    display : [
                      ...
                      {classes : "flexrow flexaround flexwrap flex", display : [
                        ...
                        },
                        {
                          ...
                          display : [
                            ...
                            {classes : "lrmargin hover2", value : "'('+@:sign(M@c.counters.svInt)+')'", click : {action : "Saving Throw", msg : "Intelligence Save", options : {"bonus" : "M@c.counters.svCha"}}}
                          ],
                        },
                        {
                          classes : "flexmiddle lrpadding",
        ...
        {icon : "plane", name : "Summary",
          display : {
            ...
            },
            {
              classes : "flexrow flexaround",
              display : [
                {target : "counters.hp", ui : "ui_maxbox"},
